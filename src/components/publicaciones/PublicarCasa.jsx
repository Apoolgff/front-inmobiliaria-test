...
import { estadoInicialCasa } from './constants/EstadosIniciales'; // Importar el estado inicial

const PublicarCasa = () => {
    const { userData } = useAuth();
    const [publicacion, setPublicacion] = useState(estadoInicialCasa); // Usar el estado inicial
